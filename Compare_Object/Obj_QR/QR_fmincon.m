function Obj_QR = QR_fmincon(mpc)
...
Qcost= sum( coeff2.*((PQ./S2).^2).*(Qg.^2)+coeff1.*(PQ./S2).*Qg+coeff0);
 ...
 Obj_QR = [Pcost,Ploss,Voltage_Profile,Lindex_max,QReserve...
                  Qcost];