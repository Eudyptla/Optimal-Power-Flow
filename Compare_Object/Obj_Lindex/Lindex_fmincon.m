function Obj_Lindex = Lindex_fmincon(mpc,T0)
...
% ====================================================================
gh_fcn = @(x) NlinFcn_Lindex_2(x,bus,gen);
...
Qcost= sum( coeff2.*((PQ./S2).^2).*(Qg.^2)+coeff1.*(PQ./S2).*Qg+coeff0);
 ...
 Obj_Lindex = [Pcost,Ploss,Voltage_Profile,Lindex_max,QReserve...
                  Qcost];
