function Obj_TC = TC_fmincon(mpc)
...
[bus, gen, branch,gencost] =...
             deal(mpc.bus, mpc.gen, mpc.branch,mpc.gencost);
...
Qcost= sum( coeff2.*((PQ./S2).^2).*(Qg.^2)+coeff1.*(PQ./S2).*Qg+coeff0);
 ...
 Obj_TC = [Pcost,Ploss,Voltage_Profile,Lindex_max,QReserve...
                  Qcost];