...
% goal = [3144,6.6777,0.09447]; weight =[0.01,0.49,0.5].*goal;
...
% goal = [3385,13.923,0.15061]; weight =[0.01,0.49,0.5].*goal;
% Original    Optimal     Goal  
%     ________    _______    _______
% 
%      4364.6      4262.9       3385
%      18.424       15.44     13.923
%     0.16252     0.16252    0.15061
%Original diverge


testcase = 'case9'; lam =1.0;
goal = [5296.7,2.3158,0.13327]; weight =[0.01,0.49,0.5].*goal;

% Original    Optimal     Goal  
%     ________    _______    _______
% 
%     5438.3       5326.5     5296.7
%     4.9547       2.9551     2.3158
%     0.1673      0.14818    0.13327

% testcase = 'case9'; lam =2.4;
% goal = [23896,23.373,0.43224]; weight =[0.01,0.49,0.5].*goal;
...
%       24707       23897      23896
%       32.26      23.405     23.373
%     0.65899     0.43315    0.43224


%testcase='case30';lam=1.0; 
%goal=[576.89,1.6036,0.049124];weight =[0.01,0.49,0.5].*goal;

%  Original    Optimal       Goal  
%     ________    ________    ________
% 
%       593.45      580.22      576.89
%       2.4438      2.0568      1.6036
%     0.055286    0.050344    0.049124

% testcase='case30';lam=1.7; 
% goal=[1178.1,6.4855,0.088856];weight =[0.01,0.49,0.5].*goal;

% Original    Optimal       Goal  
%     ________    ________    ________
% 
%      1200.9       1179.2      1178.1
%      9.0209       6.7823      6.4855
%     0.10292     0.089554    0.088856
...
% goal = [56643,42.571,0.22681] ; weight = [0.01,0.49,0.5].*goal;

% Original    Optimal     Goal  
%     ________    _______    _______
% 
%       61451       56764      56643
%      63.689      47.029     42.571
%     0.28403     0.23954    0.22681



% testcase='case57'; lam =1.0; 
% goal = [41738,11.306,0.2991];weight = [0.01,0.49,0.5].*goal;
...
% goal=[719730,210.61,0.38506];weight = [0.01,0.49,0.5].*goal;

%  Original      Optimal        Goal   
%     __________    _________    __________
% 
%     7.2475e+05    7.224e+05    7.1973e+05
%         409.57       248.87        210.61
%         0.4202       0.4202       0.38506
...
% Original
% ====================================================================
 Original_value=[totalcost,real_Ploss,Lindex_0_max]; 
% ====================================================================
% Initialization
% ====================================================================
...
% ====================================================================
f_fcn = @(x) ObjFcn_Multiobject(x,bus);
...
% ====================================================================
gh_fcn = @(x) NlinFcn_Multiobject(x,bus,gen);
