function [h,g,dh,dg] = NlinFcn_max_Voltage_Profile(x,bus,gen)
...
% ====================================================================
% Evaluate nonequality constraint function 
% ====================================================================
 Voltage_Dev = Vm(idx_L)-ones(nb-ng,1);
 Voltage_Profile= abs(Voltage_Dev);
 h=Voltage_Profile-x(nvars)*ones(nb-ng,1);
...
dg = dg';
% ====================================================================
% Evaluate partials of nonequality constraints (Gradient of h)
% ==================================================================== 
